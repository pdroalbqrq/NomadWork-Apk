...
public class ServiceTaskDelete extends AsyncTask<Void, Void, String> {
    //variables del hilo
    ...
    public ServiceTaskDelete(Context ctx, String linkAPI, Local local) {
        this.httpContext = ctx;
        this.linkrequestAPI = linkAPI;
        this.idLocal = local.getLocalId();
    }
